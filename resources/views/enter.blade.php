    ...
    <div class="row width">
        ...
        <div class="col-sm text-center">
            ...
            <form class="form-signin " action="{{ route('log-user') }}" method="post">
                ...
                <input type="email" id="inputEmail" class="form-control form-control-lg polleoform" name="email"
                       placeholder="Email adresa" required>
                <label for="inputPassword" class="sr-only">Password</label>
                <input type="password" id="inputPassword" class="form-control form-control-lg polleoform" name="pass"
